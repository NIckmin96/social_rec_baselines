...
def create_dataset(args):
	...
	click_f = np.loadtxt(f'data/{args.dataset}/ratings_data.txt', dtype = np.int32) # rating df -> txt file
	trust_f = np.loadtxt(f'data/{args.dataset}/trust_data.txt', dtype = np.int32) # trust df -> txt file
